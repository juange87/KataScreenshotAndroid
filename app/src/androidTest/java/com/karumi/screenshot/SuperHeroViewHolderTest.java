...
public class SuperHeroViewHolderTest extends ScreenshotTest {
  ...
  @Test public void showsASuperHeroWithALongDescription() {
  ...
  private SuperHero givenASuperHero(String superHeroName, String superHeroDescription, boolean isAvenger) {
